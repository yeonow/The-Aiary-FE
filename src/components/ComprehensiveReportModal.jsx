            ...
            <div className="p-6 space-y-5">
              ...
              <Card className="p-5 rounded-xl border bg-primary/10 shadow-soft">
                ...
                <p className="text-sm text-foreground/80 leading-relaxed mb-3">
                  이 기간 동안 전반적으로 <strong>평온하고 긍정적인 감정</strong>이
                  주를 이뤘어요. 특히 친구들과의 교류가 많았던 시기였네요.
                </p>

                <div className="flex gap-2 flex-wrap">
                  <div className="px-3 py-1.5 bg-card rounded-full text-xs">
                    행복 35%
                  </div>
                  <div className="px-3 py-1.5 bg-card rounded-full text-xs">
                    평온 40%
              ...
              <Card className="p-5 rounded-xl border bg-muted/20 shadow-soft">
                ...
                <p className="text-sm text-foreground/80 leading-relaxed">
                  계속해서 소중한 사람들과의 시간을 유지하세요. 또한 음악을 통한
                  감정 조절 방법도 효과적이니 앞으로도 활용해보세요. 가끔은 새로운
                  취미 활동을 시도해보는 것도 좋을 것 같아요!
                </p>
              </Card>
            </div>
  ...
  if (showStartCalendar) {
    return (
      <Dialog open={open} onOpenChange={() => setShowStartCalendar(false)}>
        <DialogContent className="max-w-[350px] w-[calc(100%-2rem)] p-0 bg-transparent border-none shadow-none">
