...
import { X, Calendar as CalendarIcon, TrendingUp, Heart, Lightbulb, ArrowRight } from "lucide-react";
...
export function ComprehensiveReportModal({ open, onClose }: ComprehensiveReportModalProps) {
