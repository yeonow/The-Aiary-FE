...
const emotions = [
  { id: "happy", label: "행복", color: "#FFF4B3" },
  { id: "sad", label: "우울", color: "#B3D9E5" },
  { id: "angry", label: "분노", color: "#E5B3B3" },
  { id: "anxious", label: "걱정", color: "#D4C4E5" },
  { id: "calm", label: "평온", color: "#C4E5D4" },
  { id: "excited", label: "설렘", color: "#FFE0A3" },
  { id: "tired", label: "피곤함", color: "#E8E8E8" },
  { id: "lonely", label: "외로움", color: "#D4C4E5" },
];

export function EmotionRecordModal({ open, onClose }: EmotionRecordModalProps) {
