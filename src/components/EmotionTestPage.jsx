...
const testList = [
  {
    ...
    title: "감정 안정성 검사",
    description: "최근 감정 변동과 정서적 안정 수준을 측정합니다.",
    icon: Heart,
  ...
  },
  {
    id: "stress-level",
    title: "스트레스 지수 테스트",
    description: "스트레스에 얼마나 노출되어 있는지 파악합니다.",
    icon: Activity,
  ...
  },
  {
    id: "resilience",
    title: "회복 탄력성 테스트",
    description: "어려움에서 얼마나 빠르게 회복하는지 측정합니다.",
    icon: TrendingUp,
  ...
  },
  {
    id: "energy-level",
    title: "에너지 레벨 테스트",
    description: "현재 신체적·정신적 에너지 상태를 확인합니다.",
    icon: Zap,
  ...
  },
  {
    ...
    title: "인지 기능 체크",
    description: "집중력과 사고 명확도를 간단히 확인합니다.",
    icon: Brain,
...
const sampleQuestions = [
  {
    id: 1,
    question: "최근 감정 기복이 자주 있다고 느끼나요?",
    options: ["아니다", "보통이다", "그렇다", "매우 그렇다"]
  },
  {
    id: 2,
    question: "스트레스 상황에서도 비교적 차분함을 유지하나요?",
    options: ["아니다", "보통이다", "그렇다", "매우 그렇다"]
  },
  {
    id: 3,
    question: "감정 때문에 일상에 방해를 받은 적이 있나요?",
    options: ["아니다", "보통이다", "그렇다", "매우 그렇다"]
  },
  {
    id: 4,
    question: "하루 동안 기분이 크게 변하지 않나요?",
    options: ["아니다", "보통이다", "그렇다", "매우 그렇다"]
  },
  {
    id: 5,
    question: "자신의 감정을 이해하기 쉽다고 느끼나요?",
    options: ["아니다", "보통이다", "그렇다", "매우 그렇다"]
  }
];
...
export function EmotionTestPage() {
  ...
  const [previousResults, setPreviousResults] = useState([
    { date: "2024년 11월 10일", score: 82, level: "양호" },
  ...
  const calculateScore = () => {
    ...
    return Math.round((total / (sampleQuestions.length * 3)) * 100);
  };
  ...
  if (showResult) {
    ...
    const testInfo = testList.find((t) => t.id === selectedTest);
      ...
      <div className="min-h-screen pb-24 w-full">
        <div className="p-6">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground">{testInfo?.title}</p>
          </div>
          ...
          <Card className="p-5 rounded-2xl border bg-card shadow-soft mb-6">
            ...
            <p className="text-sm text-foreground/80 leading-relaxed mb-4">
              {score >= 60
                ? "감정 조절 능력이 양호한 편입니다. 안정적으로 감정을 다룰 수 있어요."
                : "감정 관리가 필요해 보입니다. 스트레스 관리와 감정 조절 연습이 도움이 될 수 있어요."}
            </p>
        ...
        <div className="space-y-3">
          {currentQ.options.map((option, index) => (
            <Button
              ...
              variant="outline"
              className={`w-full h-14 rounded-xl border-2 text-left justify-start transition-all ${
